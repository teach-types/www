...
lookupW-lookupW {ρ = skip ρ} {ρ' = ρ'} {x = x}          = cong suc lookupW-lookupW
lookupW-lookupW {ρ = keep ρ} {ρ' = skip ρ'} {x = x}     = cong suc lookupW-lookupW
lookupW-lookupW {ρ = keep ρ} {ρ' = keep ρ'} {x = zero}  = refl
lookupW-lookupW {ρ = keep ρ} {ρ' = keep ρ'} {x = suc x} = cong suc lookupW-lookupW
